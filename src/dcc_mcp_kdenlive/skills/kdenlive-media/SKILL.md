---
name: kdenlive-media
description: Add file media, a color producer, or a Kdenlive title template to the project bin. Relink bin media and timeline instances to an existing local media file.
